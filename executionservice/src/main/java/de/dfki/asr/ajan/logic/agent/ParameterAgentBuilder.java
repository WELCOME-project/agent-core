...
public class ParameterAgentBuilder extends RDFAgentBuilder {
    ...
    public Agent build() throws URISyntaxException {
            ...
            LocalServicesBeliefBase localServicesBeliefs = new LocalServicesBeliefBase(beliefs);
            LocalAgentsBeliefBase localAgentsBeliefs = new LocalAgentsBeliefBase(beliefs);

            //return new Agent(url, name, template, initialBehavior, finalBehavior, behaviors, beliefs, localServicesBeliefs, localAgentsBeliefs,  events, endpoints, connections);
            return new Agent(url, id, template, initialBehavior, finalBehavior, behaviors, manageTDB, beliefs, localServicesBeliefs, localAgentsBeliefs, events, endpoints, connections);
    }
}
