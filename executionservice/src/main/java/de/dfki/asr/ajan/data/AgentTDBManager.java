...
public class AgentTDBManager {
	...
	//}
        ...
        public TripleDataBase createAgentServiceKnowledge(final String id, final boolean overwrite, final Inferencing infer) {
		return tdbManager.createTripleDataBase("lsr_" + id, overwrite, infer);
	}
        
        public TripleDataBase createLocalAgentsKnowledge(final String id, final boolean overwrite, final Inferencing infer) {
		return tdbManager.createTripleDataBase("lar_" + id, overwrite, infer);
	}
}
